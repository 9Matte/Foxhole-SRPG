...
public class World {
    ...
    public void printPathMap() {
        ...
        try
        {
            new File(pathGeneratedMaps + region).mkdirs();
            f = new File(pathGeneratedMaps + region + "/" + region + "_PATH.png");
    ...
    public void printLinkMap() {
        ...
        try {
            bufferedImage = ImageIO.read(new File(pathMaps + region + ".png"));
        } catch (IOException e) {
        ...
        try {
            new File(pathGeneratedMaps + region).mkdirs();
            File f = new File(pathGeneratedMaps + region + "/" + region + "_LINKS.png");
